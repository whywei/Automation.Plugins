...
namespace Automation.Plugins.Share.WCS
{
    public class ManualSupplyPlugin : Extension
    {
        ...
        private void AddHeaderRootItems()
        {
            ...
            header.Add(new SimpleActionItem(rootKey, "当前任务", CurrentTask_Click) { ToolTipText = "当前手工补货任务查询", GroupCaption = "查询", SortOrder = 1, LargeImage = Resource.CurrentTask_32 });
            header.Add(new SimpleActionItem(rootKey, "卷烟查询", ProductCheck_Click) { ToolTipText = "手工补货卷烟查询", GroupCaption = "查询", SortOrder = 2, LargeImage = Resource.Product_32 });
            header.Add(new SimpleActionItem(rootKey, "作业查询", AllTask_Click) { ToolTipText = "全部作业查询", GroupCaption = "查询", SortOrder =3 , LargeImage = Resource.Task_32 });
            header.Add(new SimpleActionItem(rootKey, "混合烟道", MixedChannel_Click) { ToolTipText = "混合烟道卷烟查询", GroupCaption = "查询", SortOrder = 4, LargeImage = Resource.yandao_32x32 });
        }
        ...
        {
            AutomationContext.ActivateView<CurrentTaskView>();
        }
    }
}
