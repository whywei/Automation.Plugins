...
using Automation.Plugins.YZ.ManualSupply.Model;
using Automation.Plugins.YZ.ManualSupply.Options.Controls;
...
namespace Automation.Plugins.YZ.ManualSupply.Options
{
    public class LocalDatabaseConnectionOption : AbstractOption
    {
        ...
        {
            base.Initialize();
            this.NodeName = "YZManualSupplyDatabaseConnectionOption";
            this.Caption = "手工补货器数据库连接";
            this.Order = 1;
            this.ParentNodeName = "YZManualSupplyParameterOption";
